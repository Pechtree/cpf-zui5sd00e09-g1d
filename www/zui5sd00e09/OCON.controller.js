sap.ui.controller("zui5sd00e09.OCON", {
	...
	getCTX: function(){
		...
		oModel.setData({
			...
			cancel_nav 	: false,
			oEvt		: null,
			host		: 'https://miorders4dev.cpf.co.th',
			client		: '666',
			typ			: "",
			url			: "",
			timer		: 0,
	...
	ui5DispatchFcode: function(fcode,oModela){
		...
		sap.ui.controller('zui5sd00e09.B100').M01_FCD(fcode,oModela); 
		
		sap.ui.controller('zui5sd00e09.B100').M01_DEV(fcode,oModela); 
	...
	ui5DispatchParam: function(fcode){
		...
		if(fcode=="SAPEVT_B101"){return sap.ui.controller('zui5sd00e09.B100').M02_PAR(fcode);};
		if(fcode=="SAPEVT_B102"){return sap.ui.controller('zui5sd00e09.B100').M02_PAR(fcode);};
		if(fcode=="SAPEVT_B103"){return sap.ui.controller('zui5sd00e09.B100').M02_PAR(fcode);};
		if(fcode=="SAPEVT_B104"){return sap.ui.controller('zui5sd00e09.B100').M02_PAR(fcode);};
	},
	...
	ui5DispatchModelSet: function(fcode,oModela){
		//try{
			...
			sap.ui.controller('zui5sd00e09.B100').M03_MOD(fcode,oModela);
	...
	ui5DispatchUI: function(fcode,oModela){		
		...
		sap.ui.controller('zui5sd00e09.B100').M04_DYN(fcode,oModela);
	...
	ui5DispatchNav: function(fcode,oModela){
		...
		sap.ui.controller('zui5sd00e09.B100').M05_NAV(fcode,oModela);
	...
	ui5DispatchNex: function(fcode,oModela){
		...
		sap.ui.controller('zui5sd00e09.B100').M05_NEX(fcode,oModela);
		...
		switch(apptyp){
			case '5':
				return  oCTX.oData.host +'/sap/bc/ui5_ui5/sap/'+app+'/index.html?sap-language=TH' +
				  '&sap-ui-appcache=false&sap-ui-language=EN' +
				  ...
				  "&vname=" 	 + oCon.getControl("b102inpVname").getValue() +
				  "&uname=" 	 + oCon.getControl("b102inpVname").getValue();
			break;
		
			case 'A':
				return  oCTX.oData.host +'/'+app+'/index.html?sap-language=EN' +
			...
			case 'W':
				return  oCTX.oData.host +'/sap/bc/webdynpro/sap/'+app+'?sap-language=EN' +
				  '&sap-client=' + oCTX.oData.client +
				  "&uuid="  	 + oCon.getControl("b102inpUUID").getValue() +
				  "&regid="  	 + oCon.getControl("b102inpGuid").getValue() +
				  "&guid="  	 + oCon.getControl("b102inpGuid").getValue() +
